    ...
    def evolve(self, v0, t0, times, eom="SE", solver_name="dop853", stack_state=False, verbose=False, iterate=False, imag_time=False, **solver_args):
        ...
        if eom == "SE":
            ...
            if imag_time:
                ...
                result_dtype = _np.result_type(
                    v0.dtype, self.dtype, _np.float64)
                ...
                if stack_state:
                    ...
                    if _np.iscomplexobj(_np.array(1, dtype=self.dtype)):
                        raise ValueError(
                    ...
                    v0 = _np.array(v0, dtype=_np.complex128,
                                   copy=True, order="C")
                    evolve_kwargs["f_params"] = (v0,)
        ...
        if dynamic_fmt is not None:
            if type(dynamic_fmt) is str:
                ...
                if dynamic_fmt == "dense":
                    ...
                    updates.update({func: _np.ascontiguousarray(
