...
{'cache_infile': True,
 'cache_me': {"('cc_test_flags', ['-O3'])": True,
              ...
              "('feature_flags', 'SSSE3')": ['-msse', '-msse2', '-msse3',
                                             '-mssse3'],
              "('feature_flags', {'AVX512F', 'FMA3', 'SSSE3', 'SSE2', 'SSE', 'POPCNT', 'F16C', 'SSE3', 'SSE42', 'SSE41', 'AVX', 'AVX512CD', 'AVX512_SKX', 'AVX2'})": ['-msse',
                                                                                                                                                                      '-msse2',
                                                                                                                                                                      '-msse3',
                                                                                                                                                                      '-mssse3',
                                                                                                                                                                      '-msse4.1',
              ...
              "('feature_is_supported', 'AVX', 'force_flags', 'macros', ['-march=native'], [('DETECT_FEATURES', 1)])": True,
              "('feature_is_supported', 'AVX2', 'force_flags', 'macros', None, [])": True,
              "('feature_is_supported', 'AVX2', 'force_flags', 'macros', ['-march=native'], [('DETECT_FEATURES', 1)])": True,
              "('feature_is_supported', 'AVX512CD', 'force_flags', 'macros', None, [])": True,
              "('feature_is_supported', 'AVX512CD', 'force_flags', 'macros', ['-march=native'], [('DETECT_FEATURES', 1)])": True,
              "('feature_is_supported', 'AVX512F', 'force_flags', 'macros', None, [])": True,
              "('feature_is_supported', 'AVX512F', 'force_flags', 'macros', ['-march=native'], [('DETECT_FEATURES', 1)])": True,
              "('feature_is_supported', 'AVX512_CLX', 'force_flags', 'macros', None, [])": True,
              "('feature_is_supported', 'AVX512_CLX', 'force_flags', 'macros', ['-march=native'], [('DETECT_FEATURES', 1)])": False,
              "('feature_is_supported', 'AVX512_CNL', 'force_flags', 'macros', None, [])": True,
              "('feature_is_supported', 'AVX512_CNL', 'force_flags', 'macros', ['-march=native'], [('DETECT_FEATURES', 1)])": False,
              "('feature_is_supported', 'AVX512_ICL', 'force_flags', 'macros', None, [])": True,
              "('feature_is_supported', 'AVX512_ICL', 'force_flags', 'macros', ['-march=native'], [('DETECT_FEATURES', 1)])": False,
              "('feature_is_supported', 'AVX512_KNL', 'force_flags', 'macros', None, [])": False,
              "('feature_is_supported', 'AVX512_KNL', 'force_flags', 'macros', ['-march=native'], [('DETECT_FEATURES', 1)])": False,
              "('feature_is_supported', 'AVX512_KNM', 'force_flags', 'macros', None, [])": False,
              "('feature_is_supported', 'AVX512_KNM', 'force_flags', 'macros', ['-march=native'], [('DETECT_FEATURES', 1)])": False,
              "('feature_is_supported', 'AVX512_SKX', 'force_flags', 'macros', None, [])": True,
              "('feature_is_supported', 'AVX512_SKX', 'force_flags', 'macros', ['-march=native'], [('DETECT_FEATURES', 1)])": True,
              "('feature_is_supported', 'F16C', 'force_flags', 'macros', None, [])": True,
              "('feature_is_supported', 'F16C', 'force_flags', 'macros', ['-march=native'], [('DETECT_FEATURES', 1)])": True,
              "('feature_is_supported', 'FMA3', 'force_flags', 'macros', None, [])": True,
              "('feature_is_supported', 'FMA3', 'force_flags', 'macros', ['-march=native'], [('DETECT_FEATURES', 1)])": True,
              "('feature_is_supported', 'FMA4', 'force_flags', 'macros', ['-march=native'], [('DETECT_FEATURES', 1)])": False,
              "('feature_is_supported', 'POPCNT', 'force_flags', 'macros', None, [])": True,
              "('feature_is_supported', 'POPCNT', 'force_flags', 'macros', ['-march=native'], [('DETECT_FEATURES', 1)])": True,
              "('feature_is_supported', 'SSE', 'force_flags', 'macros', None, [])": True,
              "('feature_is_supported', 'SSE', 'force_flags', 'macros', ['-march=native'], [('DETECT_FEATURES', 1)])": True,
              "('feature_is_supported', 'SSE2', 'force_flags', 'macros', None, [])": True,
              "('feature_is_supported', 'SSE2', 'force_flags', 'macros', ['-march=native'], [('DETECT_FEATURES', 1)])": True,
              "('feature_is_supported', 'SSE3', 'force_flags', 'macros', None, [])": True,
              "('feature_is_supported', 'SSE3', 'force_flags', 'macros', ['-march=native'], [('DETECT_FEATURES', 1)])": True,
              "('feature_is_supported', 'SSE41', 'force_flags', 'macros', None, [])": True,
              "('feature_is_supported', 'SSE41', 'force_flags', 'macros', ['-march=native'], [('DETECT_FEATURES', 1)])": True,
              "('feature_is_supported', 'SSE42', 'force_flags', 'macros', None, [])": True,
              "('feature_is_supported', 'SSE42', 'force_flags', 'macros', ['-march=native'], [('DETECT_FEATURES', 1)])": True,
              "('feature_is_supported', 'SSSE3', 'force_flags', 'macros', None, [])": True,
              "('feature_is_supported', 'SSSE3', 'force_flags', 'macros', ['-march=native'], [('DETECT_FEATURES', 1)])": True,
              "('feature_is_supported', 'XOP', 'force_flags', 'macros', ['-march=native'], [('DETECT_FEATURES', 1)])": False,
              "('feature_test', 'AVX', None, 'macros', [])": True,
              "('feature_test', 'AVX', ['-march=native'], 'macros', [('DETECT_FEATURES', 1)])": True,
              "('feature_test', 'AVX2', None, 'macros', [])": True,
              "('feature_test', 'AVX2', ['-march=native'], 'macros', [('DETECT_FEATURES', 1)])": True,
              "('feature_test', 'AVX512CD', None, 'macros', [])": True,
              "('feature_test', 'AVX512CD', ['-march=native'], 'macros', [('DETECT_FEATURES', 1)])": True,
              "('feature_test', 'AVX512F', None, 'macros', [])": True,
              "('feature_test', 'AVX512F', ['-march=native'], 'macros', [('DETECT_FEATURES', 1)])": True,
              "('feature_test', 'AVX512_CLX', None, 'macros', [])": True,
              "('feature_test', 'AVX512_CLX', ['-march=native'], 'macros', [('DETECT_FEATURES', 1)])": False,
              "('feature_test', 'AVX512_CNL', None, 'macros', [])": True,
              "('feature_test', 'AVX512_CNL', ['-march=native'], 'macros', [('DETECT_FEATURES', 1)])": False,
              "('feature_test', 'AVX512_ICL', None, 'macros', [])": True,
              "('feature_test', 'AVX512_KNL', None, 'macros', [])": False,
              "('feature_test', 'AVX512_KNL', ['-march=native'], 'macros', [('DETECT_FEATURES', 1)])": False,
              "('feature_test', 'AVX512_SKX', None, 'macros', [])": True,
              "('feature_test', 'AVX512_SKX', ['-march=native'], 'macros', [('DETECT_FEATURES', 1)])": True,
              "('feature_test', 'F16C', None, 'macros', [])": True,
              "('feature_test', 'F16C', ['-march=native'], 'macros', [('DETECT_FEATURES', 1)])": True,
              "('feature_test', 'FMA3', None, 'macros', [])": True,
              "('feature_test', 'FMA3', ['-march=native'], 'macros', [('DETECT_FEATURES', 1)])": True,
              "('feature_test', 'FMA4', ['-march=native'], 'macros', [('DETECT_FEATURES', 1)])": False,
              "('feature_test', 'POPCNT', None, 'macros', [])": True,
              "('feature_test', 'POPCNT', ['-march=native'], 'macros', [('DETECT_FEATURES', 1)])": True,
              "('feature_test', 'SSE', None, 'macros', [])": True,
              "('feature_test', 'SSE', ['-march=native'], 'macros', [('DETECT_FEATURES', 1)])": True,
              "('feature_test', 'SSE2', None, 'macros', [])": True,
              "('feature_test', 'SSE2', ['-march=native'], 'macros', [('DETECT_FEATURES', 1)])": True,
              "('feature_test', 'SSE3', None, 'macros', [])": True,
              "('feature_test', 'SSE3', ['-march=native'], 'macros', [('DETECT_FEATURES', 1)])": True,
              "('feature_test', 'SSE41', None, 'macros', [])": True,
              "('feature_test', 'SSE41', ['-march=native'], 'macros', [('DETECT_FEATURES', 1)])": True,
              "('feature_test', 'SSE42', None, 'macros', [])": True,
              "('feature_test', 'SSE42', ['-march=native'], 'macros', [('DETECT_FEATURES', 1)])": True,
              "('feature_test', 'SSSE3', None, 'macros', [])": True,
              "('feature_test', 'SSSE3', ['-march=native'], 'macros', [('DETECT_FEATURES', 1)])": True,
              "('feature_test', 'XOP', ['-march=native'], 'macros', [('DETECT_FEATURES', 1)])": False},
 ...
 'feature_supported': {'AVX': {'flags': ['-mavx'],
                       ...
                       'XOP': {'flags': ['-mxop'],
                               ...
                               'interest': 9}},
 'hit_cache': True,
 'parse_baseline_flags': ['-msse', '-msse2', '-msse3', '-mssse3', '-msse4.1',
                          '-mpopcnt', '-msse4.2', '-mavx', '-mf16c', '-mfma',
                          '-mavx2', '-mavx512f', '-mavx512cd', '-mavx512vl',
                          '-mavx512bw', '-mavx512dq'],
 'parse_baseline_names': ['SSE', 'SSE2', 'SSE3', 'SSSE3', 'SSE41', 'POPCNT',
                          'SSE42', 'AVX', 'F16C', 'FMA3', 'AVX2', 'AVX512F',
                          'AVX512CD', 'AVX512_SKX'],
 'parse_dispatch_names': ['AVX512_CLX', 'AVX512_CNL', 'AVX512_ICL'],
